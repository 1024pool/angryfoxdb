...
var tests = []struct {
	...
	{"zrevrange", "foozzzz 0 1", []interface{}{}},
	...
	{"zrangebyscore", "foozzzz +inf -inf withscores", []interface{}{}},
	...
	{"zrevrangebyscore", "foozzzz +inf -inf withscores", []interface{}{}},
	...
	{"zcount", "foozzz -inf +inf", 0},
	{"zcount", "foo -inf +inf", uint32(3)},
	{"zcount", "foo 1.1 (1.3", uint32(1)},
	{"zrank", "foo asdf", 2},
	{"zrevrank", "foo asdf", 0},
	{"zrank", "foo foobar", nil},
	{"zrevrank", "foo foobar", nil},
	{"zrank", "foozzz foobar", nil},
	{"zrevrank", "foozzz foobar", nil},
	{"zadd", "deletetest 1 one 2 two 3 three", uint32(3)},
	{"zremrangebyscore", "deletetesting 1 2", 0},
